...
const DEFAULT_PHOTO = "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=1000&fit=crop&q=80";
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 max-w-5xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="font-mono text-[12px] tracking-[0.2em] uppercase mt-1" style={{ color: "var(--text-3)" }}>
            ...
            <div className="flex flex-col gap-5">
              {[
                ...
                <p key={i} className="font-mono text-[13px] leading-relaxed" style={{ color: "var(--text-3)" }}>
                  {text}
                </p>
              ))}
            </div>
