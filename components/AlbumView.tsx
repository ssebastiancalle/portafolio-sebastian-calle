...
// Target row height in px — adjust to taste
      ...
      <main className="min-h-screen bg-black pt-20">
        ...
        <div className="px-6 md:px-10 pb-28">
          ...
          >
            {photos.map((photo, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    // flex-grow proportional to ratio fills rows correctly
                    flex: `${ratio} 1 ${ROW_HEIGHT * ratio}px`,
                    height: ROW_HEIGHT,
                    minWidth: 150,
                  }}
                  initial={{ opacity: 0 }}
            ...
            {/* Prevents last-row items from stretching to fill the full width */}
