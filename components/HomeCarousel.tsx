  ...
  if (isMobile) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              ...
              />
              <Link
                href={`/album/${currItem.id}`}
                className="absolute inset-0 z-10"
                aria-label={currItem.label}
              />
              <div
        ...
        <div
          className="flex flex-col items-center pb-4 pt-2 gap-1"
        ...
        >
          <div className="flex items-center gap-10">
            <button
              onClick={() => go(-1)}
              aria-label="Previous"
              className="carousel-arrow touch-manipulation transition-opacity hover:opacity-60"
              style={{
                minWidth: 44,
                minHeight: 44,
                display: "flex",
          ...
          <span
            className="font-mono text-[12px] font-bold tracking-[0.3em] uppercase select-none"
            style={{ color: "var(--text)" }}
          >
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p
                  className="font-mono text-xl tracking-widest uppercase font-bold"
                  style={{ color: "var(--text)" }}
                >
                  {mainItem.label}
                </p>
